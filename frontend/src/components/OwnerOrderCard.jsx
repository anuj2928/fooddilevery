    ...
    <div className="bg-white rounded-lg shadow p-4 space-y-4">
      ...
      <div className="flex justify-between items-center mt-auto pt-3 border-t border-gray-100">
        <span className="text-sm">
          status:{" "}
          <span className="font-semibold capitalize text-[#D96F32]">
            {data.shopOrders.status}
          </span>
        </span>

        <select
          className="rounded-md border px-3 py-1 text-sm focus:outline-none focus:ring-2 border-[#D96F32] text-[#D96F32]"
          onChange={(e) =>
            handleUpdateStatus(
              data._id,
