  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="text-right mb-4 cursor-pointer text-[#D96F32] font-medium"
        ...
        <button
          className={`w-full font-semibold py-2 rounded-lg transition duration-200 bg-[#D96F32] text-white hover:bg-[#e64323] cursor-pointer`}
        ...
        >
          ...
          <span className="text-[#D96F32]">Sign Up</span>
        </p>
      </div>
    </div>
  );
